...
The minimal copy-ready page at `/NEL/premarket_rvol.html` queries TradingView directly in the browser when it opens and refreshes every minute. It ranks by premarket volume ÷ 30-day average daily volume, excludes names more than 4 ATRs above their SMA50 using the live premarket price, and does not use a scheduled GitHub Action.
